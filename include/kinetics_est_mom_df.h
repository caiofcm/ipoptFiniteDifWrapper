 ...
 *
 */
class KineticEstCrystMOM : public TNLP
{
public:

  // My Dynamic system:
  DynamicModelRK33 *mdl;
  double *xcpy;
  double htol;
  ...
  /** default constructor */
  KineticEstCrystMOM(DynamicModelRK33 * mdl_, ParamEst *prest_);

  /** default destructor */
  virtual ~KineticEstCrystMOM();
...
private:
  ...
  //@{
  //  KineticEstCrystMOM();
  KineticEstCrystMOM(const KineticEstCrystMOM&);
  KineticEstCrystMOM& operator=(const KineticEstCrystMOM&);
  //@}
};
